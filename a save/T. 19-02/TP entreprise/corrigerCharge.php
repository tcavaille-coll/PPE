...
if($erreurs === 0){
    ...
    <form method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nomDepense" id="nomDepense" placeholder="Saisissez la depense à payé"/>
        </div>
        <div class="form-group">
            <label for="depense">somme gagner</label>
            <input type="number" class="form-control" name="depense" id="depense" placeholder="Saisissez la somme gagner"/>
        </div>
        <div class="form-group">

...
<div class="row">
    ...
    foreach($employes as $employe)
    {
        ...
        <a href="modifierEmploye.php?id=<?=$employe["idEmploye"];?>" class="btn btn-outline-primary w-100 p-3 h-50" id="bouton">Modifier</a>
        <br>
        <a href="supprimerEmploye.php?id=<?=$employe["idEmploye"];?>" class="btn btn-outline-danger w-100 p-3 h-50" id="bouton">Supprimer</a>
